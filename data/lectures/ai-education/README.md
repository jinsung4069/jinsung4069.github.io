...
Chapter 1과 Chapter 3의 사용자 지정 v2 PPTX를 실제 PowerPoint 재생 순서대로 변환했다. 원본 PPTX 및 이전 버전은 수정하지 않았다. 강의 날짜는 추가하지 않았다.

| 강의 | 슬라이드 | HTML 텍스트 구간 | 원본 이미지 개체 | 원본 SHA256 |
| --- | --- | --- | --- | --- |
| Chapter 1 | 37 | 254 | 11 | e43b9b88b685355c1396e443f30d2d0b11966a48efe8e73d1526baaf68589b22 |
| Chapter 3 | 46 | 308 | 9 | 1db1512705b0d6f64e1f114229d6e6b1b0dd87d8433307d5e411e4223cb81f20 |
...
발표자 노트는 본문과 분리된 발표자 참고 창에 원문대로 표시한다. 기본 슬라이드 화면에는 노트의 설명이나 예상 응답이 표시되지 않는다. 원문 출처 제목, 2018년 조사 및 2024년 강의 사례 표기를 유지한다. 과거 자료의 사례를 현재 사실로 갱신하지 않았다.

기존 사이트의 글래스모피즘 도구 버튼, 방향키와 A/D 이동, F 전체 화면, 목차 검색, 페이지 이동, 확대, 인쇄 및 모바일 밀기 탐색 방식을 적용했다. 추가 웹폰트는 기존 Freesentation OFL 라이선스를 따른다.

## 검증

83장 전체 브라우저 렌더링, 원문 텍스트 대응, 이미지 로딩, 글자 화면 경계, 슬라이드 순서, 목차 검색, 발표자 참고 창 분리, 키보드 이동, 전체 화면, 모바일 탐색 및 확대를 확인했다. PowerPoint 출력과 HTML 화면을 비교했다. 원본 파일의 해시와 직접 추출 이미지의 바이트 동일성을 재확인했다.
...
| 1 | 11 | 미래의 음식점 | ppt/slides/slide34.xml |
| 1 | 12 | 직업을 과업으로 나누어 보기 | ppt/slides/slide11.xml |
| 1 | 13 | 직무의 대체와 보완 | ppt/slides/slide12.xml |
| 1 | 14 | 인공지능에 대한 기대, 2018년 자료 | ppt/slides/slide35.xml |
| 1 | 15 | 인공지능에 대한 우려, 2018년 자료 | ppt/slides/slide36.xml |
| 1 | 16 | 혜택과 위험의 조건 | ppt/slides/slide13.xml |
| 1 | 17 | 02 생활 속 인공지능 | ppt/slides/slide14.xml |
| 1 | 18 | 스포츠 판정을 지원하는 AI | ppt/slides/slide15.xml |
| 1 | 19 | 추천이 관심을 추정하는 방법 | ppt/slides/slide16.xml |
| 1 | 20 | 생성형 AI의 결과와 사실 | ppt/slides/slide17.xml |
| 1 | 21 | 생성 응답의 검토, 가상 사례 | ppt/slides/slide18.xml |
| 1 | 22 | 교육에서의 맞춤 지원 | ppt/slides/slide19.xml |
| 1 | 23 | 03 개념과 발전 과정 | ppt/slides/slide20.xml |
| 1 | 24 | 인공지능의 개념 | ppt/slides/slide21.xml |
| 1 | 25 | 학습과 인식의 의미 | ppt/slides/slide22.xml |
| 1 | 26 | 초기 연구와 규칙 기반 접근 | ppt/slides/slide23.xml |
| 1 | 27 | 데이터 학습으로 넓어진 접근 | ppt/slides/slide24.xml |
| 1 | 28 | 발전의 조건과 기대의 한계 | ppt/slides/slide25.xml |
| 1 | 29 | 04 학교와 사람의 판단 | ppt/slides/slide26.xml |
| 1 | 30 | 학교에서 필요한 학습 | ppt/slides/slide27.xml |
| 1 | 31 | 교사의 판단과 학습 증거 | ppt/slides/slide28.xml |
| 1 | 32 | 인공지능 시대 대응 방안, 개인 | ppt/slides/slide37.xml |
| 1 | 33 | 인공지능 시대 대응 방안, 단체 | ppt/slides/slide38.xml |
| 1 | 34 | 선택 활동, 추천 서비스의 영향 | ppt/slides/slide30.xml |
| 1 | 35 | 활동 해설, 판단의 근거 | ppt/slides/slide31.xml |
| 1 | 36 | 형성평가 | ppt/slides/slide32.xml |
| 1 | 37 | 처음의 생각을 다시 살펴보기 | ppt/slides/slide33.xml |
...
| 3 | 11 | 교재의 세 가지 AI 교육 유형 | ppt/slides/slide8.xml |
...
| 3 | 25 | 교재에 제시된 국가별 접근 | ppt/slides/slide19.xml |
...
| 3 | 46 | 교재 과제와 정리 | ppt/slides/slide38.xml |
